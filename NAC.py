...
def a2c_step(policy_net, optimizer_policy, optimizer_value, states, advantages, batch_picked, batch_hidden):
    ...
    action = dist.sample()
    policy_loss = -dist.log_prob(action) * advantages.detach()
...
if __name__ == "__main__":
    ...
    prev_policy_model_path = None #"/project/def-m2nagapp/partha9/LTR/Combined_New_AC_policy_model_58.0.pt"
    prev_value_model_path = None #"/project/def-m2nagapp/partha9/LTR/Combined_New_AC_value_model_58.0.pt"
