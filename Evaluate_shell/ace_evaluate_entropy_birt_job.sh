...
--model_path Models/AC/Entropy/Birt/Birt_AC_Entropy_V2_policy_model_249.0.pt \
--result_path /project/def-m2nagapp/partha9/LTR/Results/AC/Entropy/Birt/ \
--test_data_path Data/TestData/Birt_test.csv \
--project_name Birt
