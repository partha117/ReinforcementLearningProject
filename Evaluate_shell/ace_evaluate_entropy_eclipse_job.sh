...
--model_path Models/AC/Entropy/Eclipse_Platform_UI/Eclipse_Platform_UI_AC_Entropy_V2_policy_model_249.0.pt \
--result_path /project/def-m2nagapp/partha9/LTR/Results/AC/Entropy/Eclipse_Platform_UI/ \
